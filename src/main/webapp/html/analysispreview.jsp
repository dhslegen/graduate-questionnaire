...
<body style="background: #ddf4ff url(img/oldbg2-bg.jpg) repeat-x; margin: 0px; padding: 0px;">
	...
	<div class="div_center"
		...
		<div class="survey_container"
			...
			<div class="analysis_survey_content" style="width:700px;text-align:left;">
				...
				<div class="div_servey_description">
					<p class="p_servey_description">问卷描述</p>
				</div>

				<div class="survid_div">
					<input type="hidden" name="analysissurveyid" value=<%=id%>>
				</div>
				<div class="surveyanalysis_div">
					<div style="display:inline">
						<h3 style="display:inline;margin:10px 110px" name="numofsurveycomplete"></h3>
						切换数据来源： <select id="leader-select" name="leader-question_datasource"
							class="textbox datasource">
							<option value="全部" selected="selected">全部</option> </select>届 </div>
				</div>
 ...
 -->
	...
	<script src="js/analysispreview.js"></script>
</body>
</html>
