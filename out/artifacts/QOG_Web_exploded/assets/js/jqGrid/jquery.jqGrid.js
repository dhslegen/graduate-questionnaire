...
//module begin
	...
	$.fn.fmatter.actions = function(cellval,opts) {
		var op={keys:false, editbutton:false, delbutton:true, editformbutton: false},
		...
		if(op.delbutton) {
			...
			// 关世旺 ---- 自定义  delOneTask(); 删除待下发的任务
			ocl = "id='jDeleteButton_"+rowid+"' onclick='delOneTask(" + rowid +");' " + hover;
